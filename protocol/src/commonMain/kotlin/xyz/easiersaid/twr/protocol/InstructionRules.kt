...
fun instructionMetadata(instruction: AtcInstruction): InstructionMetadata = when (instruction) {
    ...
    is TaxiToHoldingPoint -> InstructionMetadata(InstructionTiming.SEQUENTIAL, ClearanceDomain.GROUND, CompletionCategory.SELF_COMPLETING, mayBeConditional = true)
    is TaxiToStand -> InstructionMetadata(InstructionTiming.SEQUENTIAL, ClearanceDomain.GROUND, CompletionCategory.SELF_COMPLETING, mayBeConditional = true)

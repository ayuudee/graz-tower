...
| `icao9432-extracted::final_approach_landing_4_7_en::00baaf3c55155044` | `FINAL` report timing within 7 km / 4 NM or at 7 km if no clearance after long final. | `phraseology-later` | `split: FINAL wording covered; distance/timing remains blocked` | fn-83 proves rendered `FINAL` pilot-report wording only. 7 km / 4 NM timing remains blocked on distance-at-report evidence. |
...
| `icao9432-extracted::final_approach_landing_4_7_en::4c698a5ad52a30e4` | `LONG FINAL` report when turning final greater than 7 km / 4 NM. | `phraseology-later` | `split: LONG FINAL wording covered; final-turn distance remains blocked` | fn-83 proves rendered `LONG FINAL` pilot-report wording only. Final-turn distance remains blocked. |
...
| `icao9432-extracted::final_approach_landing_4_7_en::70e781a65920c075` | Straight-in approach `LONG FINAL` report at about 15 km / 8 NM. | `phraseology-later` | `split: straight-in LONG FINAL wording covered; straight-in timing/policy remains blocked` | fn-83 proves rendered `LONG FINAL` pilot-report wording only. Straight-in procedure policy and about-15 km / 8 NM evidence remain blocked. |

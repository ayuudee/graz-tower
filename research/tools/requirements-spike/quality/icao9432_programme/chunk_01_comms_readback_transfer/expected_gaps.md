...
| `icao9432-extracted::readback_2_8_3_en::f06dfa1cefd2d649` | `phraseology-later` | `PHRASE-1` | The words 'TAKE OFF' are used only when an aircraft is cleared for take-off, or when canceling a take-off clearance; at other t... | Wait for rendered-transmission phraseology facts. |
...
- Impact: COMMS-1 has moved to covered-green via fn-50, the contact-frequency phraseology row moved to rendered phraseology via fn-78, and the readback-termination row is split by fn-81 for supported rendered readback templates; remaining entries are phraseology, policy, model-gap, or not-applicable records.

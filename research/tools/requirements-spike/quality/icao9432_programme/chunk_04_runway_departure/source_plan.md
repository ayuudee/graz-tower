...
|---|---|---|---|---|
| `icao9432-extracted::takeoff_procedures_4_5_1_to_4_5_5_en::13264a6ac6d529c3` | Take-off clearance phraseology: `RUNWAY [designator] CLEARED FOR TAKE-OFF`. | `phraseology-later` | `phraseology-later` | `PHRASE-1`; rendered phraseology not asserted in this epic. |

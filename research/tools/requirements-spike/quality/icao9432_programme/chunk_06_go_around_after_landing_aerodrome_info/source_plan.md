...
information that the sim does not yet model as typed movement-area hazards,
facility serviceability, or aircraft-known information.
...
| `icao9432-extracted::after_landing_4_9_en::df25159c1e7b94a3` | Vacating-runway / contact-ground example phraseology. | `phraseology-later` | `phraseology-later` | `PHRASE-1`; typed frequency transfer does not prove rendered example wording. |
| `icao9432-extracted::after_landing_4_9_en::e30350fdecad45a1` | Runway-vacated / taxi-to-stand example phraseology. | `phraseology-later` | `phraseology-later` | `PHRASE-1`; rendered post-vacate dialogue is not asserted. |
| `icao9432-extracted::essential_aerodrome_information_4_10_en::01c0a4bc62b1e926` | Essential aerodrome information includes water on runway, taxiway, or apron. | `needs-observation-fact` | `model-gap` | No typed movement-area surface-contamination / water information model. |
...
| `icao9432-extracted::essential_aerodrome_information_4_10_en::18288908932d5ee8` | Essential aerodrome information definition: movement area / facilities necessary for safe aircraft operation. | `needs-observation-fact` | `model-gap` | Needs typed movement-area/facility information model before examples can be classified. |
...
| `icao9432-extracted::essential_aerodrome_information_4_10_en::502221a46fcc2879` | Essential aerodrome information includes rough or broken movement-area surfaces. | `needs-observation-fact` | `model-gap` | No typed rough/broken movement-area surface model. |
| `icao9432-extracted::essential_aerodrome_information_4_10_en::66196c8442372a96` | Essential aerodrome information includes construction or maintenance work on or adjacent to movement area. | `needs-observation-fact` | `model-gap` | No typed construction/maintenance hazard model. |
| `icao9432-extracted::essential_aerodrome_information_4_10_en::736cc42a00337fee` | Essential aerodrome information includes snow banks or drifts adjacent to movement area. | `needs-observation-fact` | `model-gap` | No typed adjacent snow-bank/drift hazard model. |
...
| `icao9432-extracted::essential_aerodrome_information_4_10_en::9b6c9dbc2af2b5b0` | Essential aerodrome information includes other temporary hazards, including parked aircraft and birds on the ground or in the air. | `needs-observation-fact` | `model-gap` | No general typed temporary-hazard model for movement area / vicinity. |
| `icao9432-extracted::essential_aerodrome_information_4_10_en::a531dea421075380` | Essential aerodrome information includes failure or irregular operation of aerodrome lighting systems. | `needs-observation-fact` | `model-gap` | No typed aerodrome-lighting serviceability model. |
| `icao9432-extracted::essential_aerodrome_information_4_10_en::c874e24413f4cdee` | Essential aerodrome information includes snow, slush, or ice on runway, taxiway, or apron. | `needs-observation-fact` | `model-gap` | No typed winter-contamination model. |

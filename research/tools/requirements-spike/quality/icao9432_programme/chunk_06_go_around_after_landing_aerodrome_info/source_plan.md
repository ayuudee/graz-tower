...
| `icao9432-extracted::after_landing_4_9_en::203b53733da22603` | Air-taxi to helicopter stand example phraseology. | `phraseology-later` | `covered-green rendered helicopter air-taxi phraseology` | `Icao9432PhraseologyEvidenceTest` covers a synthetic typed ICAO example trace rendering `G-HELI AIR-TAXI TO HELICOPTER STAND` and `AIR-TAXI TO HELICOPTER STAND G-HELI` readback. |
...
| `icao9432-extracted::after_landing_4_9_en::df25159c1e7b94a3` | Vacating-runway / contact-ground example phraseology. | `phraseology-later` | `covered-green rendered first-right/contact-ground phraseology` | `Icao9432PhraseologyEvidenceTest` covers a synthetic typed ICAO example trace rendering `TAKE FIRST RIGHT WHEN VACATED`, `CONTACT GROUND 118.350`, and the composite `FIRST RIGHT 118.350 FASTAIR 345` readback. |
...
| `icao9432-extracted::essential_aerodrome_information_4_10_en::7b81f87f5c2b4d75` | Example essential-aerodrome-information phraseology for construction, lighting, and runway condition messages. | `phraseology-later` | `covered-synthetic rendered example phraseology` | `Icao9432EssentialAerodromeInformationEvidenceTest` covers the three source examples as synthetic rendered-example evidence only; no live projection/timing/policy claim. |

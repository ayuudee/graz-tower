...
acknowledgement, and vehicle-only clear-beyond-holding-point evidence. It does
not model aircraft-operation expectation triggers, vehicle/tow extent geometry,
towing combinations, apron traffic policy, or rendered vehicle phraseology.
Aircraft taxi/runway compliance must not be reused as vehicle compliance.
...
| `icao9432-extracted::aerodrome_vehicles_crossing_towing_5_3_to_5_4_en::735b3e9ada06105b` | Vehicle/tow runway-vacated report shall wait until clear beyond holding point. | `needs-sim-model` | `split: vehicle-only clear-beyond-holding-point covered-green; tow/combined extent geometry blocked` | `Icao9432VehicleRunwaySourceBackedScenarioTest`; vehicle-only report is rejected before explicit clear-beyond-holding-point evidence. `TowExtentGeometry` remains for tow/combined extent. |
...
- Impact: fn-66/fn-65 add vehicle movement and runway evidence without changing
  current aircraft behaviour. Expected-aircraft-operation conflict triggers,
  towing metadata, tow extent geometry, and rendered phraseology remain future

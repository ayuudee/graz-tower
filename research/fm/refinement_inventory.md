...
| Route/vector control stable subset | `CURRENT_SHAPE_COMPLETE` | `ResolvedClearance.kt`, `CompletionEvaluation.kt`, `InstructionRules.kt` | `StableRuntimeCurrentShapeTest.kt`, `DeliveredMetadataParityTest.kt` | `GreenfieldRouteControlCurrentShape` | `RouteControlDeliveredReachableRefinementTheorem`, `RouteControlDeliveredAuthorizedRefinementTheorem` |

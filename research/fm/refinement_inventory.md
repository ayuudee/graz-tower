...
| Route-bearing Phase A | `WORLD_BACKED_COMPLETE` | `InstructionResolution.kt`, `ClearanceResolution.kt`, `CompletionEvaluation.kt` | `ResolvedClearanceTest.kt`, `CompletionEvaluationTest.kt`, `DeliveredMetadataParityTest.kt` | `RouteBearingResolutionBridge`, `GreenfieldRouteBearingCurrentShape`, `GreenfieldRouteBearingLifecycle` (fn-9: source-extraction now carries `airspaceProfile` on `ScopedVfrRouteSource` + `CompileVfrRouteView` with well-formedness conjuncts on `RouteBearingExtractionWellFormed` and preservation lemma `vfrRouteAirspaceProfileWellFormed_of_mem`; tracked Phase A theorems unchanged — additive widening only) | `RouteBearingDeliveredReachableRefinementTheorem`, `RouteBearingDeliveredSingleAuthorizedRefinementTheorem`, `RouteBearingDeliveredCompoundAuthorizedRefinementTheorem` |
| Route-adjacent Phase B | `WORLD_BACKED_COMPLETE` | `InstructionResolution.kt`, `ClearanceResolution.kt`, `CompletionEvaluation.kt`, `SupersessionEngine.kt` | `RouteAdjacentCurrentShapeTest.kt`, `DeliveredMetadataParityTest.kt` | `GreenfieldRouteAdjacentWorldBackedCurrentShape`, `GreenfieldRouteAdjacentWorldBackedDeliveredCurrentShape` | `RouteAdjacentDeliveredReachableRefinementTheorem`, `RouteAdjacentDeliveredAuthorizedRefinementTheorem` |
...
| Route/vector control delivered surface, including the first narrow immediate-adjunct compound layer and `TurnByDegrees` on the explicit observed-turn-progress model | `WORLD_BACKED_COMPLETE` | `InstructionResolution.kt`, `ClearanceResolution.kt`, `CompletionEvaluation.kt`, `InstructionRules.kt` | `StableRuntimeCurrentShapeTest.kt`, `RouteControlCurrentShapeTest.kt`, `DeliveredMetadataParityTest.kt` | `GreenfieldRouteControlWorldBackedDeliveredCurrentShape` | `GreenfieldRouteControlDeliveredCurrentShapeReachableIssuanceTheorem`, `GreenfieldRouteControlDeliveredCurrentShapeAuthorizedIssuanceTheorem` |
...
| Published-handoff radio jurisdiction branch | `WORLD_BACKED_COMPLETE` | `InstructionResolution.kt`, `ClearanceResolution.kt`, `CompletionEvaluation.kt` | `CommunicationsJurisdictionTest.kt`, `DeliveredMetadataParityTest.kt` | `GreenfieldRadioJurisdictionWorldBacked`, `GreenfieldCommunicationsJurisdictionDeliveredCurrentShape` | `CommunicationsJurisdictionDeliveredReachableRefinementTheorem`, `CommunicationsJurisdictionDeliveredAuthorizedRefinementTheorem` |
...
| Communications/surveillance delivered branch | `CURRENT_SHAPE_COMPLETE` | `ResolvedClearance.kt`, `CompletionEvaluation.kt`, `ActiveClearanceEngine.kt` | `CommunicationsCurrentShapeTest.kt`, `DeliveredMetadataParityTest.kt` | `GreenfieldCommunicationsExpandedCurrentShape` | `CommunicationsDeliveredReachableRefinementTheorem`, `CommunicationsDeliveredAuthorizedRefinementTheorem` |
| Runway delivered family | `WORLD_BACKED_COMPLETE` | `InstructionResolution.kt`, `ClearanceResolution.kt`, `CompletionEvaluation.kt`, `ActiveClearanceEngine.kt` | `RunwayWorldBackedCurrentShapeTest.kt`, `CompletionEvaluationTest.kt`, `DeliveredMetadataParityTest.kt` | `GreenfieldRunwayWorldBackedDeliveredCurrentShape` | `RunwayDeliveredReachableRefinementTheorem`, `RunwayDeliveredAuthorizedRefinementTheorem` |

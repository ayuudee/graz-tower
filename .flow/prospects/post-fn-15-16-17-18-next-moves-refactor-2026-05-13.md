...
promoted_ideas: [1, 2, 3, 4, 6]
promoted_to: {"1": [fn-19-fix-d-world2-pre-existing], "2": [fn-21-refresh-strategymd-5-days-stale-4-epics], "3": [fn-25-add-main-runnable-launcher-close-plan-m8], "4": [fn-22-promote-6-session-memory-captures-into], "6": [fn-24-land-pilotpilotaviationworld-projection]}
status: active
---

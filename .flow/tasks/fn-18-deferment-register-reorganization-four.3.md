...
- ~14 unfiled IDs remain at task close — all documented exclusions (round-7/8 successfully narrowed by filing 6 new Pass-12/13 closure Archive entries that absorbed regex fragments `AUDIT.2.A/2.B/2.E/4.A/4.D/9.II`):

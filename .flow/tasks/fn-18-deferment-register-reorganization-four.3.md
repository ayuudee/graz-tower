...
- `docs_missing_ids_check`: 12 entries remain raw; ALL are documented-exclusion class-i or class-iii. **Class-iii audit** (each row pairs the extraction artifact with the canonical longer ID, both verified-present as `### D-` heading in docs):

  | Extraction artifact | Canonical longer ID (has docs entry) | Source-line type |
  |---|---|---|
  | AUDIT-4-B (dotted) | AUDIT-4-B-FOLLOWUP (dotted) | narrative listing line in legacy task md inventory paragraph |
  | AUDIT-6-A (dotted) | AUDIT-6-A-FOLLOWUP (dotted) — archive entry in docs | same legacy narrative listing |
  | PASS-cap413 | PASS-cap413-2-7-principle-cite-audit, PASS-cap413-4-46-principle-cite-audit, PASS-cap413-principle-text-deep-refresh, PASS-cap413-edition-24-reconciliation (archive), PASS-cap413-edition-24-rename-pending-pdf (archive), etc. | narrative referencing the cap413 prefix family |
  | PASS-cap413-edition-23 | PASS-cap413-edition-23-comparison-unavailable (archive), PASS-cap413-edition-23-pdf-unreachable-at-task-time (archive) | fn-17.1 task md narrative + .plan |
  | PASS-cap413-edition-23-comparison | PASS-cap413-edition-23-comparison-unavailable (archive) | fn-17.1 task md narrative |
  | PASS-cap413-edition-24-rename | PASS-cap413-edition-24-rename-pending-pdf (archive) | fn-17.1 task md narrative + this task md narrative |
  | PASS-cap413-edition-24-retired-atc | PASS-cap413-edition-24-retired-atc-ga-phraseology (active in docs) | fn-17.1 task md narrative line-wrap |
  | PASS-cap413-edition-24-retired-atc-ga | PASS-cap413-edition-24-retired-atc-ga-phraseology (active in docs) | fn-17.1 task md narrative line-wrap |
  | PASS-deferments | PASS-deferments-map-tooling-automation, PASS-deferments-renumbering-discipline, PASS-deferments-cross-ref-from-impl-review (all 3 meta-deferments active in docs) | docs/deferments.md heading-row containing all three on adjacent lines |
  | PASS-fixture-per-plan-filing | PASS-fixture-per-plan-filing-time (active in docs) | narrative reference in this task md inventory description |
  | PASS-g3a-obstruction | PASS-g3a-obstruction-aerodrome-payload, PASS-g3a-obstruction-clearsAt-update, PASS-g3a-obstruction-kind-variants, plus 4 more g3a-obstruction-* IDs (all active in docs) | narrative referencing the g3a-obstruction prefix family across fn-12/13 spec siblings |
  | PASS-g3a-react | PASS-g3a-react-tailwind-limit (archive), PASS-g3a-react-personal-minimums, PASS-g3a-react-vrb-handling, etc. (10+ canonical g3a-react-* IDs in docs) | narrative referencing the g3a-react prefix family across fn-14/15 spec siblings |
  | PASS-g3b-react-cross | PASS-g3b-react-cross-aerodrome-crosswind, PASS-g3b-react-cross-aerodrome-tailwind (both active in docs) | narrative cross-reference |
  | PASS-wind-state | PASS-wind-state-migrate-to-aerodrome (bucket-3 active, pinned to fn-16) | narrative cross-reference to the fn-16 deferment |
